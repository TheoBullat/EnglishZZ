...
class DALTheme {
    ...
    func getThemeAndVocabulary(identifier: String) -> Theme {
        ...
        case "Feelings" :
            ...
            theme.addVocabulary(vocabulary: Vocabulary(name: "Surpised", imageName: "surpised", soundName: "surpised"))
        ...
        case "Numbers" :
            ...
            theme.addVocabulary(vocabulary: Vocabulary(name: "0", imageName: "0", soundName: "0"))
            theme.addVocabulary(vocabulary: Vocabulary(name: "1", imageName: "1", soundName: "1"))
            theme.addVocabulary(vocabulary: Vocabulary(name: "2", imageName: "2", soundName: "2"))
            theme.addVocabulary(vocabulary: Vocabulary(name: "3", imageName: "3", soundName: "3"))
            theme.addVocabulary(vocabulary: Vocabulary(name: "4", imageName: "4", soundName: "4"))
            theme.addVocabulary(vocabulary: Vocabulary(name: "5", imageName: "5", soundName: "5"))
            theme.addVocabulary(vocabulary: Vocabulary(name: "6", imageName: "6", soundName: "6"))
            theme.addVocabulary(vocabulary: Vocabulary(name: "7", imageName: "7", soundName: "7"))
            theme.addVocabulary(vocabulary: Vocabulary(name: "8", imageName: "8", soundName: "8"))
            theme.addVocabulary(vocabulary: Vocabulary(name: "9", imageName: "9", soundName: "9"))
    ...
    func getAllThemes() -> [Theme] {
        ...
        listTheme.append(Theme(name: "Animals", imageName: "dog", soundName: "snowWhite"))
        listTheme.append(Theme(name: "Sea", imageName: "seal", soundName: "snowWhite"))
        listTheme.append(Theme(name: "Cities", imageName: "london", soundName: "snowWhite"))
        listTheme.append(Theme(name: "Christmas", imageName: "SantaClaus", soundName: "Christmas"))
        listTheme.append(Theme(name: "Colors", imageName: "blue", soundName: "snowWhite"))
        listTheme.append(Theme(name: "School", imageName: "School", soundName: "School"))
        listTheme.append(Theme(name: "Feelings", imageName: "happy", soundName: "snowWhite"))
        listTheme.append(Theme(name: "Jobs", imageName: "postman", soundName: "snowWhite"))
        listTheme.append(Theme(name: "Disney", imageName: "snowWhite", soundName: "snowWhite"))
        listTheme.append(Theme(name: "Numbers", imageName: "1", soundName: "snowWhite"))
        listTheme.append(Theme(name: "Positions", imageName: "in", soundName: "snowWhite"))
